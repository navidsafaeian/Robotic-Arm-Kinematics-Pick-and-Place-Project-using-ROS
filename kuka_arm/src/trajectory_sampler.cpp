...
bool TrajectorySampler::OperateGripper(const bool &close_gripper)
{
  ...
  if (close_gripper)
  {
    gripper_joint_positions[0] = 0.03;  // radians - default=0.02
    gripper_joint_positions[1] = 0.03;  // radians - default=0.02
  }
  else
  {
    gripper_joint_positions[0] = -0.01;  // radians - default=0.01
    gripper_joint_positions[1] = -0.01;  // radians - default=0.01 
  }
